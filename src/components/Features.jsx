          ...
          <div className='flex- flex-col w-full relative'>
            ...
            <div className='feature-text-container'>
              <div className='flex-1 flex-center'>
                ...
                , using the same alloy that spacecragts use for missions to Mars.
                </p>
              </div>

              <div className='flex-1 flex-center'>
                <p className='feature-text g_text'>Titanium has one of the best strength-to-weight ratios
